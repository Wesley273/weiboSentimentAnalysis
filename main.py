...
from model.lstm_attention import BiLSTMAttention
from data_loader import WeiBoDataset
...
if __name__ == "__main__":
    ...
    for e in range(args.epochs):
        ...
        train_loss,train_acc = train(model,train_iter,loss_fun,optimizer,iscuda)
        train_loss_list.append(train_loss)
        train_acc_list.append(train_acc)
        test_loss,test_acc = test(model,test_iter,loss_fun,iscuda)
